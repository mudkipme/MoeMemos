...
final class AccountTests: XCTestCase {
    ...
    func testV1CompatibilitySupports0270To0310() {
        ...
        let v0300 = evaluateMemosVersionCompatibility(.v1(version: "0.30.0"))
        let v0310 = evaluateMemosVersionCompatibility(.v1(version: "0.31.0"))
        XCTAssertEqual(v0270, .supported)
        XCTAssertEqual(v0271, .supported)
        XCTAssertEqual(v0300, .supported)
        XCTAssertEqual(v0310, .supported)
    }
    ...
    func testV1CompatibilitySupports0310() {
        let result = evaluateMemosVersionCompatibility(.v1(version: "0.31.0"))
        XCTAssertEqual(result, .supported)
    }

    func testV1CompatibilityRequiresWarningForHigherThan0310() {
        let result = evaluateMemosVersionCompatibility(.v1(version: "0.31.1"))
        XCTAssertEqual(result, .v1HigherThanSupported(version: "0.31.1"))
    }
