...
**Note: Current Moe Memos version supports Memos 0.21.0 and Memos 0.27.0 to 0.30.0. Memos updates may introduce breaking API changes. If you are using a version higher than 0.30.0, it is recommended to use [Mortis](https://github.com/mudkipme/mortis) to convert the newer Memos API to the Memos 0.21.0 API and re-login in Moe Memos.**
